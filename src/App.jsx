...
const LandingPageJasa = () => {
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 relative">
      ...
      {/* --- NAVBAR --- */}
      <nav className="fixed w-full z-50 bg-white/80 backdrop-blur-md border-b border-blue-100 px-6">
        <div className="max-w-7xl mx-auto h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-2xl font-bold text-blue-900">Web<span className="text-blue-600">Pro</span></span>
          </div>
          <div className="hidden md:flex gap-8 font-medium text-slate-600">
            <a href="#services" className="hover:text-blue-600 transition">Services & Pricing</a>
            <button className="bg-blue-600 text-white px-6 py-2.5 rounded-full hover:bg-blue-700 transition">Get Started</button>
          </div>
        </div>
      </nav>
